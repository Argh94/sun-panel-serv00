...
installSunPanel() {
  ...
  checkDownload "sun-panel.gz" "https://gfg.fkj.pp.ua/app/vip/sun-panel.gz?pwd=fkjyyds666" 500000 || exit 1
  gunzip sun-panel.gz || { red "Failed to decompress sun-panel.gz!"; exit 1; }
  chmod +x sun-panel
  checkDownload "panelweb.gz" "https://gfg.fkj.pp.ua/app/vip/panelweb.gz?pwd=fkjyyds666" 50000 || exit 1
  gunzip panelweb.gz || { red "Failed to decompress panelweb.gz!"; exit 1; }
